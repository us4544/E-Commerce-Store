(function($) {
    ...
    $.Shop.prototype = {
        init: function() {
            ...
            this.cartPrefix = "Gadgets-"; // Prefix string to be prepended to the cart's name in the session storage
            ...
            this.currencyString = "Rupee"; // Currency symbol as textual string
